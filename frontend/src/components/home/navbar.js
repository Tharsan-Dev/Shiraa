...
export const NavigationBar = () => {
  ...
  {/* Conditionally render the "OwnStore" button based on user's role */}
  {role && (
    <Button href="/ShopRegister" style={{ backgroundColor: "#01e281", color:'black' }}  size="sm" className="mr-3">
      OwnStore
    </Button>
  )}
  ...
  {/* Conditionally render the login/logout button */}
  {role ? (
    <Button onClick={handleLogOut} style={{ backgroundColor: "#01e281", color:'black' }}  size="sm" className="ml-3">
      Logout
    </Button>
  ) : (
    <Button href="/login" style={{ backgroundColor: "#01e281", color:'black' }}  size="sm" className="ml-3">
      Login
    </Button>
  )}
</div>
